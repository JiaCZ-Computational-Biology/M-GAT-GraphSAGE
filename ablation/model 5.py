...
for epoch in range(1000):
    ...
    print(f"Epoch {epoch + 1:4d} | Train Loss: {avg_train_loss:.4f} | Test MSE: {test_mse_avg:.4f}")

    if test_mse_avg < best_mse:
        ...
        print(f"*** Better model found at epoch {epoch + 1}, MSE: {best_mse:.4f} ***")

print(f"\nTraining complete. Best model MSE: {best_mse:.4f}")