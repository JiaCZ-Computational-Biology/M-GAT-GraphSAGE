...
class GAT_GraphSAGE(nn.Module):
    def __init__(self, n_output=1, num_features_xd=35, output_dim=128, dropout=0.2):
        ...
        self.conv2 = SAGEConv(num_features_xd * 10, num_features_xd * 10)
...
model.load_state_dict(torch.load('D:\\pycharm\\gutingle\\pythonProject2\\突出核蛋白\\best_gat_graphsage_model.pth'))
model.eval()
