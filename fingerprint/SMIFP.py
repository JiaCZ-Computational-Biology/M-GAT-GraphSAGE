...
def get_smifp(smiles, nbits=1024):
    ...
    # Generate n-gram features (1-gram, 2-gram, 3-gram)
    for n in range(1, 4):
    ...
    # Map character counts to fingerprint
...
for index, row in train_df.iterrows():
    ...
    try:
        ...
        train_data_list.append((data, smifp))
...
for epoch in range(1000):
    ...
    for batch_data, batch_smifp in train_loader:
        optimizer.zero_grad()
